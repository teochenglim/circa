...
`cmd/circa` landed with v0.1.0 — see [ARCHITECTURE.md](ARCHITECTURE.md) for the as-built layout. The table below tracks the *planned* release scope per [DESIGN/09](DESIGN/09_design_tech_stack_and_roadmap.md) §9.2's milestone list, so progress becomes traceable as each one is actually built.
...
| [v0.2.0](RELEASE/v0.2.0.md) | Visibility (UI, compression) | Not started |
